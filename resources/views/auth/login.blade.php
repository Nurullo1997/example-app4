                        ...
                        <form action="{{ route('authenticate') }}" method="POST">
                            ...
                            <div class="form-group py-1 pb-2">
                                <div class="input-field">
                                    ...
                                    <button class="btn bg-white text-muted"> <span
                                            class="far fa-eye-slash"></span></button>
                                </div>
                            </div>
                            <div class="form-inline"> <input type="checkbox" name="remember" id="remember">
                                <labelfor="remember" class="text-muted">Eslab qolish</label>
                                <a href="#"id="forgot" class="font-weight-bold">Paro'lni unutdingizmi?</a>
                            </div>
                            ...
                            <div class="text-center pt-4 text-muted">Ro'yxatdan o'tmaganmisiz?
                                <a href="{{route('register')}}">Ro'rxatdan o'tish</a>
                            </div>
                        </form>
                    </div>
